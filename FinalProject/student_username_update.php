...
<form method = "post">
<input type  ="text" name = "username" class = "input-box" placeholder = "USERNAME"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE comp_first SET username = '$username' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">USERNAME UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
