...
<?php
     ...
     $i = "1";
     $sql = "select Name,qualification,role from staff where department = 'Computer Department' and role = 'HOD'";
     ...
     $qualification = $row["qualification"];
        ...
        ?>
            ...
            <?php
            $sql1 = "select Name,qualification,role from staff where department = 'Computer Department' and role != 'HOD'";
