...
<form method = "post">
<input type  ="text" name = "sem" class = "input-box" placeholder = "SEMESTER"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    $sem = $_POST['sem'];
    $sql = "UPDATE comp_first SET Semester = '$sem' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">SEMSETER UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
