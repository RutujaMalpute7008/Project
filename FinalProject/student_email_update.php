...
<form method = "post">
<input type  ="text" name = "email" class = "input-box" placeholder = "EMAIL-ID"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    $email = $_POST['email'];
    $sql = "UPDATE comp_first SET Email_id = '$email' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">EMAIL-ID UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
