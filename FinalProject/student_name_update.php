...
<form method = "post">
<input type  ="text" name = "name" class = "input-box" placeholder = "NAME"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    $name = $_POST['name'];
    $sql = "UPDATE comp_first SET Name = '$name' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">NAME UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
