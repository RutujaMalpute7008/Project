...
?>
   ...
   <center> <div class = "view_notice">
    <div class = "heading_view">ADMIN UPLOADED NOTICES</div><br>
        
    <?php 
    $sql = "select * from dept_notice where role = 'ADMIN' and department = '$department'";
    $result = mysqli_query($conn,$sql);
                if($result -> num_rows > 0){?>
                    ...
                    <td><button ><a href = "notice/<?php echo $row['file']?>" class = "btn btn-success">VIEW</a></button></td>
