...
<form method = "post">
<input type  ="text" name = "year" class = "input-box" placeholder = "YEAR"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    $year = $_POST['year'];
    $sql = "UPDATE comp_first SET year = '$year' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">YEAR UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
