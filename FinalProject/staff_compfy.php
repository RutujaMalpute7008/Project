...
<?php   
  ...
  $sql1 = "select Name,Enrollment_no,dob,address,mobile_no,Email_id from comp_first where Enrollment_no = '$rollno' and year = 'first'";
...
<center><table>
    ...
    $sql = "select Name,Enrollment_no from comp_first where year = 'first' ";
