...
<?php
    ...
    if(!empty($_GET['file'])){
        $file = $_GET['file'];
        $db = "select * from  assignment where file=? ";
...
<html>
        ...
        <br>
        <center><div class = "heading">ASSIGNMENTS</div><br><br></center>
</html>
            <?php 
                if($result-> num_rows > 0){?>
                    ...
                    <td><a href = "assigndownload.php?file=<?php echo "$file"?>" class = "btn btn-success">DOWNLOAD</a></td>
                        </tr><?php 
                        $i++;  
                      }
                      echo "</table";
