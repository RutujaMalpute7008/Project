...
if(isset($_REQUEST['upload'])){
    ...
    if(in_array($ext,$allowed)){
        ...
        $sql = "INSERT into dept_notice(subject,file,Uploaded_date,staff_name,role,department) VALUES('$subject','$file','$date','$Name','$role','$department')";
...
?>
    ...
    <?php 
    $sql = "select * from dept_notice where staff_name = '$Name'";
