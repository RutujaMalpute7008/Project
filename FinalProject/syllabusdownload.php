...
<?php
    ...
    if(!empty($_GET['file'])){
        $file = $_GET['file'];
        $db = "select * from  syllabus where file=? ";
...
<html>
        ...
        <br>
        <center><div class = "heading">SYLLABUS</div><br><br></center>
</html>
            <?php 
                if($result-> num_rows > 0){?>
                    ...
                    <td><a href = "syllabusdownload.php?file=<?php echo "$file"?>" class = "btn btn-success">DOWNLOAD</a></td>
                        </tr><?php 
                        $i++;  
                      }
                      echo "</table";
