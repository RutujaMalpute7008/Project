...
<form method = "post">
<input type  ="text" name = "mbno" class = "input-box" placeholder = "MOBILE-NO"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    $mbno = $_POST['mbno'];
    $sql = "UPDATE comp_first SET mobile_no = '$mbno' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">MOBILE-NO UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
