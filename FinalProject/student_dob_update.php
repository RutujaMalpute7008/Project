...
<form method = "post">
<input type  ="text" name = "dob" class = "input-box" placeholder = "DOB"><input type  ="submit" name = "submit" class = "button_upload" value = "UPDATE">
...
if(isset($_POST['submit'])){
    $dob = $_POST['dob'];
    $sql = "UPDATE comp_first SET dob = '$dob' WHERE Name = '$Name' and Enrollment_no = '$rollno'";
    if(mysqli_query($conn,$sql)){
        ?><center><div class = "success">DOB UPDATES SUCCESSFULLY</div></center><?php
    }
}
?>
